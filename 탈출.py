...
# 물이 있는 칸과 인접해있는 비어있는 칸(적어도 한 변을 공유)은 물이 차게 된다. 물과 고슴도치는 돌을 통과할 수 없다. 또, 고슴도치는 물로 차있는 구역으로 이동할 수 없고, 
# 물도 비버의 소굴로 이동할 수 없다.
...
# 물이 차는 시간과 고슴도치가 이동하는 시간 계산, 고슴도치가 이동할 수 있는 칸 체크.
# 물이 차는 시간과 고슴도치가 이동하는 시간 비교
# 고슴도치가 비버의 굴에 도착하면 시간 출력, 도착하지 못하면 "KAKTUS" 출력